                ...
                <div className="my-8 md:border px-12 md:rounded-lg md:shadow-lg md:shadow-gray-800 pb-8 md:p-8 md:w-80 max-w-sm">
                    ...
                    <form method="post" className="flex flex-col">
                        ...
                        <div className="flex flex-col space-y-4 py-4">
                            <button className="hover:bg-gray-300 border border-gray-800 shadow-gray-800 shadow  rounded-lg py-4 md:py-2  font-semibold" type="submit">Log in</button>
                            <a className="hover:bg-gray-300 border border-gray-800 shadow-gray-800 shadow  rounded-lg py-4 md:py-2  font-semibold text-center" href="/register">Register</a>
